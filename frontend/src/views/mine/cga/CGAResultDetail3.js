...
const CGAResultDetail3 = ({ visible, setVisible, cga, staffList }) => {
        ...
        <CModalBody style={{ fontFamily: 'sans serif' }}>
          ...
          {cga2?.length > 0 && cga1?.length > 0 ? (
                ...
                <CTable small striped bordered>
                  <CTableHead>
                    ...
                    <CTableRow>
                      ...
                      <CTableHeaderCell>TOTAL AVG</CTableHeaderCell>
                    </CTableRow>
                  </CTableHead>
                  <CTableBody>
                    {cga2?.map((val, key) => {
                      return (
                        <CTableRow key={key}>
                          ...
                          {val.current_competency_level ? (
                            <CTableDataCell>
                              {(val.expected_level - cga1[key]?.current_competency_level) * 0.3}
                            </CTableDataCell>
                          ) : (
                            <CTableDataCell>N/A</CTableDataCell>
                          )}
                          {val.current_competency_level ? (
                            <CTableDataCell>
                              {(val.expected_level - cga2[key]?.current_competency_level) * 0.7}
                            </CTableDataCell>
                          ) : (
                            <CTableDataCell>N/A</CTableDataCell>
                          )}
            ...
            <CTable>
              <CTableRow>
                <CTableDataCell colSpan={4} style={{ color: 'red' }}>
                  Complete Self and Superior Submission
                </CTableDataCell>
              </CTableRow>
            </CTable>
          )}
...
export default CGAResultDetail3
