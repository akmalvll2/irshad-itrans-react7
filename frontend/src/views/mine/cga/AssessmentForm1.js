        ...
        <CModalBody>
          <CCard className="my-2">
            <CCardBody className="bg-light">
              <CRow>
                <CCol md={8}>
                  <h5 className=" text-info text-center">{selectedAssessment?.assessment_name}</h5>
                </CCol>
                <CCol md={4}>
                      ...
                      <CTableBody>
                        ...
                        <CTableRow>
                          ...
                          <CTableDataCell>
                            ...
                            complex situations, is recognized as a leader in the field, and provides
                            thought leadership while setting strategic direction
                          </CTableDataCell>
                        </CTableRow>
                      </CTableBody>
                    </CTable>
                                                  ...
                                                  <CTableDataCell className="align-middle text-center">
                                                    <CFormCheck
                                                      ...
                                                      checked={
                                                        result?.find(
                                                          (i) =>
                                                            i.competencyid === val.competency_id,
